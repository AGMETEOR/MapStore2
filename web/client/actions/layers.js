...
module.exports = {
    ...
    hideLayerMetadata, download, updateSettingsParams, addGroup, showLayerSwipeSettings, hideLayerSwipeSettings,
    ...
    CLEAR_LAYERS, SELECT_NODE, FILTER_LAYERS, SHOW_LAYER_METADATA, HIDE_LAYER_METADATA, UPDATE_SETTINGS_PARAMS, SHOW_LAYER_SWIPE_SETTINGS, HIDE_LAYER_SWIPE_SETTINGS
};
